...
# %%
def corrector_scha_03to10(wb, newCode = False, shortURL=None):
...
# %%
def corrector_scha_03to12(wb_xbrl, df_avancor, df_matrica):
    ...
    shortURL = ['SR_0420502_R3_P1',
                ...
                'SR_0420502_R3_P9',
                'SR_0420502_R4']
    sheet_xbrl_period = listSheetsName(wb_xbrl, shortURL)
...
def corrector_scha_03to12_(wb_xbrl, df_avancor, df_matrica, shortURL=None):
    """ Вставляем данные о периоде отчетности """
    # Формы:
    # 0420502 Справка о стоимости ч_3   SR_0420502_R3_P1
    # 0420502 Справка о стоимости ч_4   SR_0420502_R3_P4
...
def corrector_scha_13(id_fond, wb_xbrl, df_avancor, df_id):
    ...
    sheetName = sheetNameFromUrl(codesSheets(wb_xbrl), 'SR_0420502_R5')
...
# %%
def corrector_Podpisant_2_(ws_xbrl, df_identifier, sheet_name, cell_with_fio, ERRORS, errors_file):
